...
{"name":"OnlineAvatar","status":true,"description":"Firebaseを使ってプレイヤーをオンライン同期します。","parameters":{"apiKey":"AIzaSyAXxt3BJASYHC5H5X2qnTeUwmyhGgyMopQ","authDomain":"freesuro2.firebaseapp.com","databaseURL":"https://freesuro2.firebaseio.com","avatarEvent":"64","syncSwitchStart":"101","syncSwitchEnd":"180","syncVariableStart":"500","syncVariableEnd":"3002"}},
...
{"name":"Trb_LoadingAnimation","status":true,"description":"ローディング画面をアニメーションさせるプラグイン","parameters":{"コマ数":"3","再生速度":"20","x":"","y":"50"}},
...
{"name":"LoadingExtend","status":false,"description":"ロード中画像拡張プラグイン","parameters":{"イメージ列数":"1","イメージ行数":"3","表示タイプ":"2","アニメーション間隔":"30","表示位置X座標":"","表示位置Y座標":"","待機フレーム数":"1","点滅なし":"OFF"}}
];
